...
public class PatrolEnemyAI : MonoBehaviour
{
    ...
    public int maxTimeBeforeTurn;
    private int currentTimeBeforeTurn;
    ...
    void Start()
    {
        ...
        currentTimeBeforeTurn = maxTimeBeforeTurn;
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (currentTimeBeforeTurn > 0)
        {
            currentTimeBeforeTurn += -1;
        }
        else if (currentTimeBeforeTurn == 0)
        {
            currentTimeBeforeTurn = maxTimeBeforeTurn;
            Flip();
        }
